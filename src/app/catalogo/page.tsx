...
const categorias: Categoria[] = [
  ...
  },
  {
    ...
    servicos: [
      ...
      {
        nome: "Reconstrução de sobrancelha (1 sessão)",
        preco: "R$ 180",
      },
      {
        nome: "Reconstrução de sobrancelha (3 sessões)",
        preco: "R$ 500",
      },
      {
        nome: "Lash lift",
      ...
      { nome: "Limpeza de pele", preco: "R$ 200" },
      { nome: "Nano fios", preco: "R$ 480" },
      { nome: "Nano brow", preco: "R$ 550" },
      { nome: "Nano lips", preco: "R$ 550" },
      {
        nome: "Neutralização labial",
        preco: "R$ 750",
        observacao: "Com 1 retoque incluído",
      },
      {
        nome: "Hydra gloss",
        preco: "R$ 150",
  ...
  //   },
  {
    ...
    servicos: [
      ...
      { nome: "Epilação do rosto", preco: "R$ 90" },
